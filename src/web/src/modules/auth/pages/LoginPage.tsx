      ...
      >
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg mb-4">
            <img src={`${import.meta.env.BASE_URL}logo.svg`} alt="Agent Hands" width={56} height={56} />
          </div>
          <h1 className="font-display text-[28px] font-normal tracking-tight text-ink leading-tight">Agent Hands</h1>
