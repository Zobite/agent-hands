...
export interface AgentHandsLogoProps extends SVGProps<SVGSVGElement> {
  color?: string;
  bgColor?: string;
}

export function AgentHandsLogo({ color = "currentColor", bgColor = "var(--background, #ffffff)", ...props }: AgentHandsLogoProps) {
  return (
    <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" aria-label="Agent Hands Logo" role="img" {...props}>
      <title>Agent Hands Logo</title>
