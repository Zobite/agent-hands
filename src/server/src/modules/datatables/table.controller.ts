...
import { executeMqlQuery } from "./mql-query.service.js";
import { MqlParseError } from "./mql-parser.js";
import {
...
/**
 * Register table routes nested under /:projectId/tables/...
 * All routes are scoped to a specific project.
 */
